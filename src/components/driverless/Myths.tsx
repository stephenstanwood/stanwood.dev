...
const myths: Myth[] = [
  ...
  },
  {
    ...
    verdict: "false",
    reality:
      "As of July 2026, commercial driverless rides are running in San Francisco, Los Angeles, Phoenix, Austin, Atlanta, Miami, and Nashville — seven metros across six states. Dallas, Houston, and DC are next on Waymo's 2026 expansion list.",
