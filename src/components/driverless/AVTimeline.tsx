...
const events: TimelineEvent[] = [
  ...
  { date: "Feb 2026", title: "Waymo opens four cities in one day", detail: "Dallas, Houston, San Antonio, and Orlando all start carrying public riders on February 24, taking Waymo to 10 commercial metros.", type: "launch" },
  ...
  { date: "Mar 2026", title: "500K rides per week", detail: "Waymo reaches half a million paid rides per week and sets a target of one million by year-end. Nashville opens in April.", type: "milestone" },
  { date: "Apr 2026", title: "Tesla launches paid unsupervised robotaxi rides", detail: "Tesla runs paid robotaxi rides with nobody in the front seat, expanding the Austin service area and adding Dallas and Houston. The geo-fenced service uses Model Ys — the first Cybercabs were not registered in Texas until August 2026.", type: "launch" },
  { date: "Jul 2026", title: "First federal OK for a car with no steering wheel", detail: "Regulators grant Zoox the first commercial exemption ever issued to a purpose-built robotaxi, clearing it to charge for rides in a vehicle that was never built for a human driver.", type: "policy" },
  { date: "Aug 2026", title: "Zoox starts charging fares in Las Vegas", detail: "Paid rides begin on and around the Strip — the first commercial service run by a vehicle with no steering wheel or pedals.", type: "launch" },
  { date: "Aug 2026", title: "Waymo drops the waitlist in Dallas and Houston", detail: "Both Texas cities open to anyone with the app, putting Waymo in 11 metros, with driverless testing under way in Denver, Las Vegas, San Diego, and Tampa.", type: "milestone" },
];
